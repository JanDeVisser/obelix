...
#define instruction_create_jump(l)          ((data_t *) data_create(ITJump, data_charval((l)), NULL))
...
#define instruction_create_next(n)          ((data_t *) data_create(ITNext, data_charval((n)), NULL))
...
#define instruction_create_test(l)          ((data_t *) data_create(ITTest, data_charval((l)), NULL))
