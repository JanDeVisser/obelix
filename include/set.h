...
extern set_t *  set_clone(set_t *);
extern set_t *  set_copy(set_t *);
extern set_t *  set_set_type(set_t *, type_t *);
extern set_t *  set_set_free(set_t *, free_t);
extern set_t *  set_set_hash(set_t *, hash_t);
extern set_t *  set_set_copy(set_t *, copy_t);
...
#define intset_create()       (set_set_type(set_create(NULL), coretype(CTInteger)))
#define strset_create()       (set_set_type(set_create(NULL), coretype(CTString)))
