...
extern int ErrorLexerExhausted;
...
extern parser_t * parser_start(parser_t *);
extern data_t *   parser_parse(parser_t *, data_t *);
extern data_t *   parser_parse_reader(parser_t *, data_t *);
extern data_t *   parser_send_token(parser_t *, token_t *);
extern data_t *   parser_end(parser_t *);
...
extern parser_t * parser_log(parser_t *, data_t *);
extern parser_t * parser_set_variable(parser_t *, data_t *);
extern parser_t * parser_pushval(parser_t *, data_t *);
extern parser_t * parser_push(parser_t *);
extern parser_t * parser_push_token(parser_t *);
extern parser_t * parser_push_const(parser_t *, data_t *);
extern parser_t * parser_discard(parser_t *);
extern parser_t * parser_dup(parser_t *);
extern parser_t * parser_push_tokenstring(parser_t *);
extern parser_t * parser_bookmark(parser_t *);
extern parser_t * parser_pop_bookmark(parser_t *);
extern parser_t * parser_rollup_list(parser_t *);
extern parser_t * parser_rollup_name(parser_t *);
extern parser_t * parser_rollup_nvp(parser_t *);
extern parser_t * parser_new_counter(parser_t *);
extern parser_t * parser_incr(parser_t *);
extern parser_t * parser_count(parser_t *);
extern parser_t * parser_discard_counter(parser_t *);
