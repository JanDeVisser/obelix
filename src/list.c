...
void test_list_prepend(list_t *list, char *data) {
  listiterator_t *iter = li_create(list);
  li_insert(iter, data);
  test_print_list(list, "After list_prepend");  
}

void test_list_insert(list_t *list, char *data) {
  listiterator_t *iter = li_create(list);
  li_next(iter);
  li_insert(iter, data);
  test_print_list(list, "After list_insert");  
}

void test_list_tail_insert(list_t *list, char *data) {
  listiterator_t *iter = li_create(list);
  li_tail(iter);
  li_insert(iter, data);
  test_print_list(list, "After list_tail_insert");  
}

void test_list_last_insert(list_t *list, char *data) {
  listiterator_t *iter = li_create(list);
  li_tail(iter);
  li_prev(iter);
  li_insert(iter, data);
  test_print_list(list, "After list_last_insert");
}
...
void test_suite() {
  ...
  test_list_prepend(list, "test0");
  test_list_insert(list, "test0.1");
  test_list_tail_insert(list, "test2.xx");
  test_list_last_insert(list, "test2.1");
