...
CHECK_SIMPLE_INSTR("mov bp,sp", MOV_BP_SP)
CHECK_SIMPLE_INSTR("mov sp,bp", MOV_SP_BP)
CHECK_INDEXED("mov si,bp{}", MOV_SI_BP_IDX)
CHECK_INDEXED("mov di,bp{}", MOV_DI_BP_IDX)
CHECK_INDEXED("mov di,si{}", MOV_DI_SI_IDX)
CHECK_INDEXED("mov a,bp{}", MOV_A_BP_IDX)
CHECK_INDEXED("mov b,bp{}", MOV_B_BP_IDX)
CHECK_INDEXED("mov c,bp{}", MOV_C_BP_IDX)
CHECK_INDEXED("mov d,bp{}", MOV_D_BP_IDX)
CHECK_INDEXED("mov bp{},si", MOV_BP_IDX_SI)
CHECK_INDEXED("mov bp{},di", MOV_BP_IDX_DI)
CHECK_INDEXED("mov si{},di", MOV_SI_IDX_DI)
CHECK_INDEXED("mov bp{},a", MOV_BP_IDX_A)
CHECK_INDEXED("mov bp{},b", MOV_BP_IDX_B)
CHECK_INDEXED("mov bp{},c", MOV_BP_IDX_C)
CHECK_INDEXED("mov bp{},d", MOV_BP_IDX_D)
CHECK_SIMPLE_INSTR("push bp", PUSH_BP)
CHECK_SIMPLE_INSTR("pop bp", POP_BP)
CHECK_8BIT_IMM("push {}", PUSH_IMM)
CHECK_16BIT_IMM("pushw {}", PUSHW_IMM)
CHECK_SIMPLE_INSTR("push ab", PUSH_AB)
CHECK_SIMPLE_INSTR("push cd", PUSH_CD)
CHECK_INDEXED("push bp{}", PUSH_BP_IDX)
CHECK_SIMPLE_INSTR("pop ab", POP_AB)
CHECK_SIMPLE_INSTR("pop cd", POP_CD)
CHECK_INDEXED("pop bp{}", POP_BP_IDX)
CHECK_16BIT_IMM("jnc {}", JNC)
CHECK_16BIT_IMM_IND("jnc {}", JNC_IND)
CHECK_SIMPLE_INSTR("add c,a", ADD_C_A)
CHECK_SIMPLE_INSTR("adc c,a", ADC_C_A)
CHECK_SIMPLE_INSTR("sub c,a", SUB_C_A)
CHECK_SIMPLE_INSTR("sbb c,a", SBB_C_A)
CHECK_SIMPLE_INSTR("and c,a", AND_C_A)
CHECK_SIMPLE_INSTR("or c,a", OR_C_A)
CHECK_SIMPLE_INSTR("xor c,a", XOR_C_A)
CHECK_SIMPLE_INSTR("add c,b", ADD_C_B)
CHECK_SIMPLE_INSTR("adc c,b", ADC_C_B)
CHECK_SIMPLE_INSTR("sub c,b", SUB_C_B)
CHECK_SIMPLE_INSTR("sbb c,b", SBB_C_B)
CHECK_SIMPLE_INSTR("and c,b", AND_C_B)
CHECK_SIMPLE_INSTR("or c,b", OR_C_B)
CHECK_SIMPLE_INSTR("xor c,b", XOR_C_B)
CHECK_SIMPLE_INSTR("add d,a", ADD_D_A)
CHECK_SIMPLE_INSTR("adc d,a", ADC_D_A)
CHECK_SIMPLE_INSTR("sub d,a", SUB_D_A)
CHECK_SIMPLE_INSTR("sbb d,a", SBB_D_A)
CHECK_SIMPLE_INSTR("and d,a", AND_D_A)
CHECK_SIMPLE_INSTR("or d,a", OR_D_A)
CHECK_SIMPLE_INSTR("xor d,a", XOR_D_A)
CHECK_SIMPLE_INSTR("add d,b", ADD_D_B)
CHECK_SIMPLE_INSTR("adc d,b", ADC_D_B)
CHECK_SIMPLE_INSTR("sub d,b", SUB_D_B)
CHECK_SIMPLE_INSTR("sbb d,b", SBB_D_B)
CHECK_SIMPLE_INSTR("and d,b", AND_D_B)
CHECK_SIMPLE_INSTR("or d,b", OR_D_B)
CHECK_SIMPLE_INSTR("xor d,b", XOR_D_B)
