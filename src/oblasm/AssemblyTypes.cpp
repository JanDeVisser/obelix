...
OpcodeDefinition opcode_definitions[256] = {
    ...
    /* mov rsp,sp      */ { Mnemonic::MOV, AMRegister, Register::rsp, AMRegister, Register::sp, 1 },
    /* mov sp,rsp      */ { Mnemonic::MOV, AMRegister, Register::sp, AMRegister, Register::rsp, 1 },
    /* mov si,rsp[$xx] */ { Mnemonic::MOV, AMRegister, Register::si, AMIndexed, Register::rsp, 2 },
    /* mov di,rsp[$xx] */ { Mnemonic::MOV, AMRegister, Register::di, AMIndexed, Register::rsp, 2 },
    /* mov di,si[$xx]  */ { Mnemonic::MOV, AMRegister, Register::di, AMIndexed, Register::si, 2 },
    /* mov a,si[$xx]   */ { Mnemonic::MOV, AMRegister, Register::a, AMIndexed, Register::si, 2 },
    /* mov b,si[$xx]   */ { Mnemonic::MOV, AMRegister, Register::b, AMIndexed, Register::si, 2 },
    /* mov c,si[$xx]   */ { Mnemonic::MOV, AMRegister, Register::c, AMIndexed, Register::si, 2 },
    /* mov d,si[$xx]   */ { Mnemonic::MOV, AMRegister, Register::d, AMIndexed, Register::si, 2 },
    /* mov rsp[$xx],si */ { Mnemonic::MOV, AMIndexed, Register::rsp, AMRegister, Register::si, 2 },
    /* mov rsp[$xx],di */ { Mnemonic::MOV, AMIndexed, Register::rsp, AMRegister, Register::di, 2 },
    /* mov si[$xx],di  */ { Mnemonic::MOV, AMIndexed, Register::si, AMRegister, Register::di, 2 },
    /* mov si[$xx],a   */ { Mnemonic::MOV, AMIndexed, Register::si, AMRegister, Register::a, 2 },
    /* mov si[$xx],b   */ { Mnemonic::MOV, AMIndexed, Register::si, AMRegister, Register::b, 2 },
    /* mov si[$xx],c   */ { Mnemonic::MOV, AMIndexed, Register::si, AMRegister, Register::c, 2 },
    /* mov si[$xx],d   */ { Mnemonic::MOV, AMIndexed, Register::si, AMRegister, Register::d, 2 },
    /* push rsp        */ { Mnemonic::PUSH, AMRegister, Register::rsp, AMNone, Register::None, 1 },
    /* pop rsp         */ { Mnemonic::POP, AMRegister, Register::rsp, AMNone, Register::None, 1 },
